...
public class TemplateAdminServiceImpl implements TemplateAdminService {
    ...
    @Autowired
    private CategoryTemplateAdminService categoryTemplateService ;
    @Autowired
    private TechnologyAdminService technologyService ;
    @Autowired
    private LevelTemplateAdminService levelTemplateService ;
    @Autowired
    private TypeTemplateAdminService typeTemplateService ;
    @Autowired
