...
import ma.zs.zyn.service.facade.collaborator.inscription.InscriptionMembreStateCollaboratorService ;
...
import java.util.List;
@Service
public class InscriptionMembreCollaboratorServiceImpl implements InscriptionMembreCollaboratorService {
    ...
    @Autowired
    private InscriptionMembreStateCollaboratorService inscriptionMembreStateService ;
    @Autowired
