...
import ma.zs.zyn.service.facade.influencer.inscription.InscriptionMembreStateInfluencerService ;
...
import java.util.List;
@Service
public class InscriptionMembreInfluencerServiceImpl implements InscriptionMembreInfluencerService {
    ...
    @Autowired
    private InscriptionMembreStateInfluencerService inscriptionMembreStateService ;
    @Autowired
