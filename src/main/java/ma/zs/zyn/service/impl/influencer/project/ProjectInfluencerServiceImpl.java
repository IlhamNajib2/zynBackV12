...
import ma.zs.zyn.service.facade.influencer.project.ProjectStateInfluencerService ;
...
import ma.zs.zyn.service.facade.influencer.template.ProjectTemplateInfluencerService ;
...
public class ProjectInfluencerServiceImpl implements ProjectInfluencerService {
    ...
    @Autowired
    private ProjectStateInfluencerService projectStateService ;
    @Autowired
    private DomainTemplateInfluencerService domainTemplateService ;
    @Autowired
    private ProjectTemplateInfluencerService projectTemplateService ;
