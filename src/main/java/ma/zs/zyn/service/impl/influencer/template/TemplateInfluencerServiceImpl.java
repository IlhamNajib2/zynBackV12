package ma.zs.zyn.service.impl.influencer.template;
...
import ma.zs.zyn.service.facade.influencer.template.TemplateInfluencerService;
...
import ma.zs.zyn.service.facade.influencer.template.CategoryTemplateInfluencerService ;
...
import ma.zs.zyn.service.facade.influencer.template.LevelTemplateInfluencerService ;
import ma.zs.zyn.bean.core.template.LevelTemplate ;
import ma.zs.zyn.service.facade.influencer.template.TypeTemplateInfluencerService ;
import ma.zs.zyn.bean.core.template.TypeTemplate ;
import ma.zs.zyn.service.facade.influencer.template.DomainTemplateInfluencerService ;
import ma.zs.zyn.bean.core.template.DomainTemplate ;
import ma.zs.zyn.service.facade.influencer.collaborator.MemberInfluencerService ;
import ma.zs.zyn.bean.core.collaborator.Member ;

import java.util.List;
@Service
public class TemplateInfluencerServiceImpl implements TemplateInfluencerService {
    ...
    @Autowired
    private CategoryTemplateInfluencerService categoryTemplateService ;
    @Autowired
    private TechnologyInfluencerService technologyService ;
    @Autowired
    private LevelTemplateInfluencerService levelTemplateService ;
    @Autowired
    private TypeTemplateInfluencerService typeTemplateService ;
    @Autowired
    private DomainTemplateInfluencerService domainTemplateService ;
    @Autowired
    private MemberInfluencerService memberService ;
