package ma.zs.zyn.service.impl.member.inscription;
...
import ma.zs.zyn.service.facade.member.inscription.InscriptionCollaboratorMemberService;
...
import ma.zs.zyn.service.facade.member.collaborator.CollaboratorMemberService ;
import ma.zs.zyn.bean.core.collaborator.Collaborator ;
import ma.zs.zyn.service.facade.member.inscription.InscriptionMembreMemberService ;
import ma.zs.zyn.bean.core.inscription.InscriptionMembre ;
import ma.zs.zyn.service.facade.member.inscription.InscriptionCollaboratorTypeMemberService ;
import ma.zs.zyn.bean.core.inscription.InscriptionCollaboratorType ;
import ma.zs.zyn.service.facade.member.packaging.PackagingMemberService ;
import ma.zs.zyn.bean.core.packaging.Packaging ;
import ma.zs.zyn.service.facade.member.inscription.InscriptionCollaboratorStateMemberService ;
import ma.zs.zyn.bean.core.inscription.InscriptionCollaboratorState ;

import java.util.List;
@Service
public class InscriptionCollaboratorMemberServiceImpl implements InscriptionCollaboratorMemberService {
    ...
    @Autowired
    private CollaboratorMemberService collaboratorService ;
    @Autowired
    private InscriptionMembreMemberService inscriptionMembreService ;
    @Autowired
    private InscriptionCollaboratorTypeMemberService inscriptionCollaboratorTypeService ;
    @Autowired
    private PackagingMemberService packagingService ;
    @Autowired
    private InscriptionCollaboratorStateMemberService inscriptionCollaboratorStateService ;
