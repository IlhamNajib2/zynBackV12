package ma.zs.zyn.service.impl.member.packaging;
...
import ma.zs.zyn.service.facade.member.category.CategoryPackagingMemberService ;
import ma.zs.zyn.bean.core.category.CategoryPackaging ;

import java.util.List;
@Service
public class PackagingMemberServiceImpl implements PackagingMemberService {
    ...
    @Autowired
    private CategoryPackagingMemberService categoryPackagingService ;
