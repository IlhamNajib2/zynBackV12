package ma.zs.zyn.service.impl.member.paiment;
...
import ma.zs.zyn.service.facade.member.paiment.PaimentCollaboratorMemberService;
...
import ma.zs.zyn.service.facade.member.coupon.CouponDetailMemberService ;
import ma.zs.zyn.bean.core.coupon.CouponDetail ;
import ma.zs.zyn.service.facade.member.project.PaimentCollaboratorStateMemberService ;
...
import java.util.List;
@Service
public class PaimentCollaboratorMemberServiceImpl implements PaimentCollaboratorMemberService {
    ...
    @Autowired
    private CouponDetailMemberService couponDetailService ;
    @Autowired
    private PaimentCollaboratorStateMemberService paimentCollaboratorStateService ;
    @Autowired
    private InscriptionCollaboratorMemberService inscriptionCollaboratorService ;
