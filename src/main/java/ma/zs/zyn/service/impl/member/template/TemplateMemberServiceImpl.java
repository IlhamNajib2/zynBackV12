...
import ma.zs.zyn.service.facade.member.template.TemplateMemberService;
...
import ma.zs.zyn.service.facade.member.template.LevelTemplateMemberService ;
...
import java.util.List;
@Service
public class TemplateMemberServiceImpl implements TemplateMemberService {
    ...
    @Autowired
    private CategoryTemplateMemberService categoryTemplateService ;
    @Autowired
    private TechnologyMemberService technologyService ;
    @Autowired
    private LevelTemplateMemberService levelTemplateService ;
    @Autowired
