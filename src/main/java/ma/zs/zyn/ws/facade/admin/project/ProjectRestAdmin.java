...
public class ProjectRestAdmin {
    ...
    public long countProjectsByWeek(@RequestParam("date") String date) {
        ...
        return service.countProjectsByWeek(localDate);
    }

    @GetMapping("countProjectsByMonth")
    public long countProjectsByMonth(@RequestParam("date") String date) {
        LocalDate localDate = LocalDate.parse(date);
        return service.countProjectsByMonth(localDate);
    }

    @GetMapping("countProjectsByYear")
    public long countProjectsByYear(@RequestParam("date") String date) {
        LocalDate localDate = LocalDate.parse(date);
        return service.countProjectsByYear(localDate);
    }
