package  ma.zs.zyn.ws.facade.collaborator.category;
...
import ma.zs.zyn.service.facade.collaborator.category.CategoryPackagingCollaboratorService;
...
@RestController
@RequestMapping("/api/collaborator/categoryPackaging/")
public class CategoryPackagingRestCollaborator {
    ...
    @Autowired private CategoryPackagingCollaboratorService service;
