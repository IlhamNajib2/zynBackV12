...
import ma.zs.zyn.service.facade.collaborator.coupon.CouponDetailCollaboratorService;
...
@RestController
@RequestMapping("/api/collaborator/couponDetail/")
public class CouponDetailRestCollaborator {
    ...
    @Autowired private CouponDetailCollaboratorService service;
