...
@RestController
@RequestMapping("/api/collaborator/inscriptionMembre/")
public class InscriptionMembreRestCollaborator {
    ...
    @Autowired private InscriptionMembreCollaboratorService service;
