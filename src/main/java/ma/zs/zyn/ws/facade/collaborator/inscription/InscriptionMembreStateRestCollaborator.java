...
@RestController
@RequestMapping("/api/collaborator/inscriptionMembreState/")
public class InscriptionMembreStateRestCollaborator {
    ...
    @Autowired private InscriptionMembreStateCollaboratorService service;
