...
@RestController
@RequestMapping("/api/collaborator/paimentInfluencerState/")
public class PaimentInfluencerStateRestCollaborator {
    ...
    @Autowired private PaimentInfluencerStateCollaboratorService service;
