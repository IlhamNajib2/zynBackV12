...
import ma.zs.zyn.service.facade.collaborator.project.ProjectStateCollaboratorService;
...
@RestController
@RequestMapping("/api/collaborator/projectState/")
public class ProjectStateRestCollaborator {
    ...
    @Autowired private ProjectStateCollaboratorService service;
