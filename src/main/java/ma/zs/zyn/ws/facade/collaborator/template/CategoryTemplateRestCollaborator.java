...
@RestController
@RequestMapping("/api/collaborator/categoryTemplate/")
public class CategoryTemplateRestCollaborator {
    ...
    @Autowired private CategoryTemplateCollaboratorService service;
