...
@RestController
@RequestMapping("/api/collaborator/projectTemplate/")
public class ProjectTemplateRestCollaborator {
    ...
    @Autowired private ProjectTemplateCollaboratorService service;
