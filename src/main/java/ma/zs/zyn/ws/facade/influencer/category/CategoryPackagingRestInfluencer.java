package  ma.zs.zyn.ws.facade.influencer.category;
...
import ma.zs.zyn.service.facade.influencer.category.CategoryPackagingInfluencerService;
...
@RestController
@RequestMapping("/api/influencer/categoryPackaging/")
public class CategoryPackagingRestInfluencer {
    ...
    @Autowired private CategoryPackagingInfluencerService service;
