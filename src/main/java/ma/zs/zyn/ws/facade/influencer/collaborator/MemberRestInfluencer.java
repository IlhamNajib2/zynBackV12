package  ma.zs.zyn.ws.facade.influencer.collaborator;
...
@RestController
@RequestMapping("/api/influencer/member/")
public class MemberRestInfluencer {
    ...
    @Autowired private MemberInfluencerService service;
