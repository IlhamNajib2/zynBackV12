...
@RestController
@RequestMapping("/api/influencer/inscriptionCollaborator/")
public class InscriptionCollaboratorRestInfluencer {
    ...
    @Autowired private InscriptionCollaboratorInfluencerService service;
