...
@RestController
@RequestMapping("/api/influencer/inscriptionCollaboratorType/")
public class InscriptionCollaboratorTypeRestInfluencer {
    ...
    @Autowired private InscriptionCollaboratorTypeInfluencerService service;
