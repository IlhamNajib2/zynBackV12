...
@RestController
@RequestMapping("/api/influencer/inscriptionMembreState/")
public class InscriptionMembreStateRestInfluencer {
    ...
    @Autowired private InscriptionMembreStateInfluencerService service;
