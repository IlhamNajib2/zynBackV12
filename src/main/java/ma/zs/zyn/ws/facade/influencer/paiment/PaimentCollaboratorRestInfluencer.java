package  ma.zs.zyn.ws.facade.influencer.paiment;
...
@RestController
@RequestMapping("/api/influencer/paimentCollaborator/")
public class PaimentCollaboratorRestInfluencer {
    ...
    @Autowired private PaimentCollaboratorInfluencerService service;
