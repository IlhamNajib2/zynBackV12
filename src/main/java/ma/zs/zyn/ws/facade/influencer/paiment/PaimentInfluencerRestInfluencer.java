...
@RestController
@RequestMapping("/api/influencer/paimentInfluencer/")
public class PaimentInfluencerRestInfluencer {
    ...
    @Autowired private PaimentInfluencerInfluencerService service;
