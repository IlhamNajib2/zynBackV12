...
@RestController
@RequestMapping("/api/influencer/paimentCollaboratorState/")
public class PaimentCollaboratorStateRestInfluencer {
    ...
    @Autowired private PaimentCollaboratorStateInfluencerService service;
