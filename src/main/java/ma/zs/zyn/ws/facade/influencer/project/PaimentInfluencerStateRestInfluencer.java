...
@RestController
@RequestMapping("/api/influencer/paimentInfluencerState/")
public class PaimentInfluencerStateRestInfluencer {
    ...
    @Autowired private PaimentInfluencerStateInfluencerService service;
