package  ma.zs.zyn.ws.facade.member.collaborator;
...
@RestController
@RequestMapping("/api/member/collaborator/")
public class CollaboratorRestMember {
    ...
    @Autowired private CollaboratorMemberService service;
