...
@RestController
@RequestMapping("/api/member/inscriptionCollaborator/")
public class InscriptionCollaboratorRestMember {
    ...
    @Autowired private InscriptionCollaboratorMemberService service;
