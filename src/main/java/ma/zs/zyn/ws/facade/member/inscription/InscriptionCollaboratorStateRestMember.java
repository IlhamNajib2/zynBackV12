...
@RestController
@RequestMapping("/api/member/inscriptionCollaboratorState/")
public class InscriptionCollaboratorStateRestMember {
    ...
    @Autowired private InscriptionCollaboratorStateMemberService service;
