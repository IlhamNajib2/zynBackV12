...
@RestController
@RequestMapping("/api/member/inscriptionCollaboratorType/")
public class InscriptionCollaboratorTypeRestMember {
    ...
    @Autowired private InscriptionCollaboratorTypeMemberService service;
