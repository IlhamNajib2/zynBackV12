package  ma.zs.zyn.ws.facade.member.inscription;
...
@RestController
@RequestMapping("/api/member/inscriptionMembre/")
public class InscriptionMembreRestMember {
    ...
    @Autowired private InscriptionMembreMemberService service;
