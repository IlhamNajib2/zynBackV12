package  ma.zs.zyn.ws.facade.member.packaging;
...
@RestController
@RequestMapping("/api/member/packaging/")
public class PackagingRestMember {
    ...
    @Autowired private PackagingMemberService service;
