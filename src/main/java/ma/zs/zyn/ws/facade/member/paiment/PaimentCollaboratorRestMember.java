package  ma.zs.zyn.ws.facade.member.paiment;
...
@RestController
@RequestMapping("/api/member/paimentCollaborator/")
public class PaimentCollaboratorRestMember {
    ...
    @Autowired private PaimentCollaboratorMemberService service;
