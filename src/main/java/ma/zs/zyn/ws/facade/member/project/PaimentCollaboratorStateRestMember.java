package  ma.zs.zyn.ws.facade.member.project;
...
@RestController
@RequestMapping("/api/member/paimentCollaboratorState/")
public class PaimentCollaboratorStateRestMember {
    ...
    @Autowired private PaimentCollaboratorStateMemberService service;
