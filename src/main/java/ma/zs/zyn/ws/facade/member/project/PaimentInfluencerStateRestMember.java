...
@RestController
@RequestMapping("/api/member/paimentInfluencerState/")
public class PaimentInfluencerStateRestMember {
    ...
    @Autowired private PaimentInfluencerStateMemberService service;
