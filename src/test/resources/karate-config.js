function fn() {
    ...
    config.adminUri = config.rootUrl + 'api/admin/';
        ...
        config.categoryTemplateUrl = config.adminUri + 'categoryTemplate/';
    ...
    config.typeTemplateUrl = config.adminUri + 'typeTemplate/';
    ...
    config.levelTemplateUrl = config.adminUri + 'levelTemplate/';
    config.technologyUrl = config.adminUri + 'technology/';
    config.templateUrl = config.adminUri + 'template/';
